...
LABELS_PATTERN = {
    ...
    "TEMPAT_TGL_LAHIR": r'\b(T[Ee3aA\[\]\s]*[MSms]?[Pp]?[Aa4@\._]*[Tt]?[/\.,\s]*T[Aa4@nN]*[GGg0]*[LLl1]*[/\.,\s]*L[Aa4@][HHh][Ii1|][RRr]|TEMPAT[/\.,\s]*TGL[/\.,\s]*LAHIR|TEMPAT[/\.,\s]*TANGGAL[/\.,\s]*LAHIR|TEMPAT[/\.,\s]*LAHIR|TEMPATTGL|TEMPAT\s*TG|TESPAT[/\.,\s]*TGI|TGL[/\.,\s]*LAHIR|TTL|empat[/\.,\s]*T|empatt[/\.,\s]*T|empat[/\.,\s]*Latrir|empatt[/\.,\s]*Latrir|tempat[/\.,\s]*Latrir|at/Tgl|t/Tgl|Lah|Lahir)\b',
    ...
    "ALAMAT": r'\b([Aa4@][Ll1|][Aa4@][MmNn][Aa4@][Tt1i|]|ALAMAT|ALAMAL|ALAMAI|ALAMTI|ALMT|ALAMT|LAMAT|AMAT)\b',
    "RT_RW": r'\b(R[Tt1i|][\s\/\.-]*R[WwVv]|RT[\s\/\.-]*RW|RTIRW|RTRW|RIRW|ATAW|RT/AW|T/RW|T/AW|RT/RAW|RT/RN)\b',
    "KEL_DESA": r'\b(K[Ee3][Ll1|][/\.\s]*D[Ee3][Ss5][Aa4@]|KEL[/\.\s]*DESA|KELLDESA|KELDESA|KELURAHAN[/\.\s]*DESA|DESA[/\.\s]*KELURAHAN|KELURAHAN|DESA|el/Desa|l/Desa)\b',
...
_NAMA_STOP_FRAGMENTS = [
    ...
    "LAHIR", "TTL", "JENIS", "KELAMIN", "KELAM1N",
    "GOL", "DARAH", "GOLDARAH",
